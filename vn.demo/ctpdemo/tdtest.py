...
def simple_log(func):
    ...
    def wrapper(*args, **kw):
        print ""
        print str(func.__name__), datetime.datetime.utcnow()
        return func(*args, **kw)
    return wrapper
...
class TestTdApi(TdApi):
    ...
    def onFrontConnected(self):
        """服务器连接"""
        sleep(100)
        print 'onFrontConnected sleep 100'
        pass
...
def main():
    ...
    # 登陆，测试通过
    loginReq = {}                           # 创建一个空字典
    loginReq['UserID'] = '090254'         # 参数作为字典键值的方式传入
    loginReq['Password'] = 'chenyuxiong'         # 键名和C++中的结构体成员名对应
    loginReq['BrokerID'] = '9999'
    reqid = reqid + 1                       # 请求数必须保持唯一性
    print 'loginReq: ', loginReq
