...
class DrEngine(object):
    ...
    # ----------------------------------------------------------------------
    def postDrTick(self,content):
        """发出Tick的数据到绘图中"""
        event = Event(type_=EVENT_DATARECORDER_TICK)
        event.dict_['data'] = content
        self.eventEngine.put(event)


    # ----------------------------------------------------------------------
    def postDrBar(self, content):
        """发出Bar的数据到绘图中"""
        event = Event(type_=EVENT_DATARECORDER_BAR)
        event.dict_['data'] = content
        self.eventEngine.put(event)
